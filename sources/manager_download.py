...
async def init_download_manager(user_login: str):
    await DownloadManager.load_remote_resources(
        ...
        waka_7days=f"http://wakapi.陈莹.我爱你/api/compat/wakatime/v1/users/current/stats/last_7_days?api_key={EM.WAKATIME_API_KEY}",
        waka_last_12_months=f"http://wakapi.陈莹.我爱你/api/compat/wakatime/v1/users/current/stats/last_12_months?api_key={EM.WAKATIME_API_KEY}",
